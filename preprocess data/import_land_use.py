...
land_cover_plot["recat"].loc[land_cover_plot["nivell_2"].isin([111,112,113,114,115,116])] = "Agriculture"
land_cover_plot["recat"].loc[land_cover_plot["nivell_2"].isin([221,222,223,224,225,226,227,228,229])] = "Forest"
land_cover_plot["recat"].loc[land_cover_plot["nivell_2"].isin([230,231,232,233,234])] = "Others"
land_cover_plot["recat"].loc[land_cover_plot["nivell_2"].isin([341,342,343,344,345,346,347,348,349,350,351,352,352,353, 354,355])] = "Urban"
